...
const { createAbsensiPayload, updateAbsensiPayload } = require("../payloads/absensi.payload");
...
const getDetailAbsen = async (req, res) => {
  try {
    ...
    return responseSuccess(req, res, httpStatus.SUCCESS, 'Get Absensi Detail', response);
  } catch (error) {
...
module.exports = { getListAbsen, createAbsen, getDetailAbsen, updateAbsen };
